...
class Model(object):
    ...
    '''
    def _fit(self, f, ins, out_labels=[], batch_size=128, nb_epoch=100, verbose=1, callbacks=[], val_f=None, val_ins=None, shuffle=True, metrics=[]):
        '''
...
class Sequential(Model, containers.Sequential):
    ...
    '''
    def compile(self, optimizer, loss, class_mode="categorical", sample_weight_mode=None):
